...
export async function generateMemoPdf(facts, deadlines, suppressed, review = [], notificationRecord = null, services = [], advisories = [], contingent = []) {
  ...
  }, review, notificationRecord, services, advisories, contingent);
}
